    ...
    <>
      <div className="swiper-pay2">
        <Swiper
          ...
          className="relative group flex items-center justify-center border-[1px] border-[#FF720C] rounded-[10px] w-full overflow-hidden"
        >
          <SwiperSlide className="swiper-slide-pay">
            <div className="flex items-end justify-center text-[15px] text-[#00000045] font-semibold">
              <p>7,500,000</p>
              <p className="text-[15px] mr-[8px]">ریال</p>
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide-pay">
            <div className=" flex items-end justify-center text-[15px] text-[#00000045] font-semibold">
          ...
          <SwiperSlide className="swiper-slide-pay">
            <div className=" flex items-end text-[15px] justify-center text-[#00000045] font-semibold">
              <p>20,000,000</p>
              <p className="text-[15px] mr-[8px]">ریال</p>
            </div>
          </SwiperSlide>
          <SwiperSlide className="swiper-slide-pay">
            <div className=" flex items-end text-[15px] justify-center text-[#00000045] font-bold">
              <p>30,000,000</p>
              <p className="text-[15px] mr-[8px]">ریال</p>
            </div>
          </SwiperSlide>
          ...
          <div className="absolute flex justify-center items-center h-full  w-[35px] top-auto left-0 bg-[#fff] cursor-pointer  z-10">
            <div className="absolute flex justify-center items-center h-[60px] w-[30px] top-auto left-4  rounded-[8px] bg-[#FF720C]  cursor-pointer button-next-slide z-10 ">
              <img src="assest/images/planLoan/positive.svg" alt="" />
            </div>
          </div>
          <div className="absolute flex justify-center items-center h-full  w-[35px] top-auto right-0 bg-[#fff] cursor-pointer  z-10">
            <div className="absolute flex justify-center items-center h-[60px] w-[30px] top-auto right-4  rounded-[8px] bg-[#FF720C]  cursor-pointer button-prev-slide z-10 ">
              <img src="assest/images/planLoan/negative.svg" alt="" />
            </div>
          </div>
        </Swiper>
      </div>
